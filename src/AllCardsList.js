...
<Breadcrumb path={['All Cards > Select a card']} />
      ...
      <div className="sort">
        ...
        <button
          className={`sort-button${sortBy === 'youngest' ? ' active' : ''}`}
          onClick={() => handleSortChange('youngest')}
        >
          Youngest
        </button>

        <button
          className={`sort-button${sortBy === 'eldest' ? ' active' : ''}`}
          onClick={() => handleSortChange('eldest')}
        >
          Eldest
        </button>
      </div>
        ...
        {people.map((person) => (
          <div key={person.name} className="card">
            <div className="card-content">
              ...
              <svg className="plus-svg" width="12" height="13" viewBox="0 0 12 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6 1.49998V11.5" stroke="#3B3B3B" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M1 6.49998H11" stroke="#3B3B3B" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              ...
              <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_31_13979)">
                  <path d="M7.5 15C10.8137 15 13.5 12.3137 13.5 9C13.5 5.68629 10.8137 3 7.5 3C4.18629 3 1.5 5.68629 1.5 9C1.5 12.3137 4.18629 15 7.5 15Z" stroke="#3B3B3B" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M15.0641 12.5C15.5611 13.843 15.5771 14.923 15.0001 15.5C13.6191 16.881 9.36612 14.866 5.50012 11C1.63412 7.134 -0.380884 2.881 1.00012 1.5C1.57712 0.923 2.65712 0.939 4.00012 1.436" stroke="#3B3B3B" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                </g>
                <defs>
              ...
              <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_31_10650)">
                  ...
                  <path d="M8 5C9.10457 5 10 4.10457 10 3C10 1.89543 9.10457 1 8 1C6.89543 1 6 1.89543 6 3C6 4.10457 6.89543 5 8 5Z" stroke="#3B3B3B" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                </g>
                <defs>
              ...
              <svg width="16" height="17" viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_31_7343)">
                  ...
                  <path d="M8.49188 3.22399C6.49788 2.36499 4.09688 2.74999 2.46788 4.37899C2.13388 4.71299 1.85888 5.08199 1.62988 5.46999L3.96988 7.80999" stroke="#3B3B3B" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M13.2659 7.97301C14.1459 9.97401 13.7609 12.393 12.1219 14.032C11.7879 14.366 11.4189 14.641 11.0299 14.871L8.67993 12.521" stroke="#3B3B3B" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M6.81193 13.549L2.95093 9.688C2.95093 9.688 6.24893 1.483 15.4999 1C14.9769 10.211 6.81193 13.549 6.81193 13.549Z" stroke="#3B3B3B" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
